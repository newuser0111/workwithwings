...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Work with Wings network..."),
        ...
        ("install_tip", "Due to UAC, Work with Wings Support can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install RustDesk to the system."),
        ...
        ("powered_by_me", "Powered by Work with Wings"),
